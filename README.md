...
bt_robot adalah package ROS2 berbasis Python untuk mengendalikan robot TurtleBot3 menggunakan logika Behavior Tree sederhana. Robot dapat maju saat jalan kosong dan berbelok ketika mendeteksi obstacle menggunakan sensor LIDAR.
